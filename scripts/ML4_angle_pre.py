...
import numpy as np
try:
    from ML4_angle import DualTargetModelWrapper, get_triple_enhanced_features
except ImportError:
    sys.exit(1)

def main():
    INPUT_CSV = './output/angles.csv'
    OUTPUT_CSV = './output/angles_with_predictions.csv'
    ...
    smiles_c_list = df['smiles3'].tolist()
    try:
        X_features, _ = get_triple_enhanced_features(smiles_a_list, smiles_b_list, smiles_c_list)
